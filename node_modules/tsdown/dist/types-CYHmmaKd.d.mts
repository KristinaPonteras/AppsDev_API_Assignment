...
interface ResolvedDepsConfig extends Pick<DepsConfig, "neverBundle" | "resolveDepSubpath"> {
...
declare function DepsPlugin({ pkg, deps: { neverBundle, alwaysBundle: jsAlwaysBundle, onlyBundle, onlyImport, resolveDepSubpath: shouldResolveDepSubpath, dts }, logger, nameLabel, platform }: ResolvedConfig, tsdownBundle: TsdownBundle): Plugin;
//#endregion
...
/** @ts-ignore - optional dep */
type Options = import("publint").Options;
...
type UserConfigFn = (inlineConfig: InlineConfig, context: UserConfigFnContext) => Awaitable<Arrayable<UserConfig>>;
type UserConfigExport = Awaitable<Arrayable<UserConfig> | UserConfigFn>;
type ResolvedConfig = Overwrite<MarkPartial<Omit<UserConfig, "workspace" | "fromVite" | "external" | "noExternal" | "logLevel" | "failOnWarn" | "suppressWarnings" | "customLogger" | "envFile" | "envPrefix">, "globalName" | "inputOptions" | "outputOptions" | "minify" | "define" | "alias" | "onSuccess" | "outExtensions" | "hooks" | "copy" | "loader" | "name" | "banner" | "footer" | "checks" | "css">, {
  /**
...
//#endregion
export { CopyEntry as $, ChunkAddonObject as A, NODE_SEA_MIN_VERSION as B, TsdownPlugin as C, AttwOptions as D, ExportsOptions as E, PackageType as F, DepsPlugin as G, SeaConfig as H, BuildContext as I, Logger as J, NoExternalFn as K, RolldownContext as L, OutExtensionFactory as M, OutExtensionObject as N, ChunkAddon as O, PackageJsonWithPath as P, TsdownHandle as Q, TsdownHooks as R, ReportPlugin as S, PublintOptions as T, DevtoolsOptions as U, NODE_SEA_MIN_VERSION_PARSED as V, DepsConfig as W, RolldownChunk as X, globalLogger as Y, TsdownBundle as Z, ConcurrencyExecutor as _, NormalizedFormat as a, toArray as b, TreeshakingOptions as c, UserConfig as d, CopyOptions as et, UserConfigExport as f, Workspace as g, WithEnabled as h, InlineConfig as i, Overwrite as it, OutExtensionContext as j, ChunkAddonFunction as k, TsdownInputOption as l, UserConfigFnContext as m, DtsOptions as n, Arrayable as nt, ResolvedConfig as o, UserConfigFn as p, ResolvedDepsConfig as q, Format as r, MarkPartial as rt, Sourcemap as s, CIOption as t, CopyOptionsFn as tt, UnusedOptions as u, importWithError as v, TsdownPluginOption as w, ReportOptions as x, resolveComma as y, ExeOptions as z };